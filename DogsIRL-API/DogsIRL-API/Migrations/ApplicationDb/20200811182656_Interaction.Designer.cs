...
namespace DogsIRL_API.Migrations.ApplicationDb
{
    ...
    [Migration("20200811182656_Interaction")]
            ...
            modelBuilder.Entity("DogsIRL_API.Models.PetCard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Bravery = (short)9,
                            DateCollected = new DateTime(2020, 8, 11, 11, 26, 56, 419, DateTimeKind.Local).AddTicks(162),
                            DateCreated = new DateTime(2020, 8, 11, 11, 26, 56, 417, DateTimeKind.Local).AddTicks(902),
                            Energy = (short)8,
                            Floofiness = (short)1,
                            GoodDog = (short)8,
